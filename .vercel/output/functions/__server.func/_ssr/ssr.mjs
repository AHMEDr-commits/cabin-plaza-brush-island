...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-7m-J75mH.mjs");
...
var manifest = {
	"b08d9cb8b5c50a921bb70906a183814a5a2e2498c613b7f84686fd0dd45b4388": {
		functionName: "fetchPageText_createServerFn_handler",
		importer: () => import("./fetch-page-fGZyFQol.mjs")
	},
	"f4765370ab8d02f04211ab1a592f12c89e855bcfb9666a38a0d4126d9a8021e4": {
		functionName: "completeChat_createServerFn_handler",
		importer: () => import("./complete-DCB99lAp.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DaNE3WWD.mjs").then((n) => n.t),
